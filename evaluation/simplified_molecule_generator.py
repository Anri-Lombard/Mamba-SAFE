...
def generate_molecules(designer, n_samples, max_length, top_k, top_p, temperature, n_trials, max_retries=10):
...
def evaluate_model(model_dir, tokenizer_path, n_samples, max_length, top_k, top_p, temperature, n_trials, output_file, append, max_retries):
    ...
    generated_smiles = generate_molecules(designer, n_samples, max_length, top_k, top_p, temperature, n_trials, max_retries)
...
if __name__ == "__main__":
    ...
    evaluate_model(args.model_dir, args.tokenizer_path, args.num_samples, args.max_length, 
                   args.top_k, args.top_p, args.temperature, args.n_trials, args.output_file, args.append, args.max_retries)