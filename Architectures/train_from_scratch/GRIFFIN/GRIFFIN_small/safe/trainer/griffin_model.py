...
# ============================================================================
"""Griffin model for SAFE library."""
...
class GriffinModel(PreTrainedModel):
    ...
    def __init__(
        ...
        self.final_norm = layers.RMSNorm(width=self.config.width)
    ...
    def forward(
        ...
        if inputs_embeds is None:
            inputs_embeds = self.embedder(input_ids)
...
class GriffinForCausalLM(PreTrainedModel):
    def __init__(self, config):
        super().__init__(config)
        self.griffin = GriffinModel(config)
    ...
    def forward(
        ...
        transformer_outputs = self.griffin(
            input_ids,
